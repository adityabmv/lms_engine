...
from ..assessment.views import StandAloneAssessmentViewSet
from ..assessment.views.assessment import VideoAssessmentViewSet
from .views import *
...
router.register(r'items/assessments', StandAloneAssessmentViewSet, basename='assessment')
